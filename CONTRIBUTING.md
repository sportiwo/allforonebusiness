Contributing to AllForOneBusiness Core
============================

The AllForOneBusiness Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/allforonebusiness-project/allforonebusiness/blob/master/doc/translation_process.md)
...
The following applies to code changes to the AllForOneBusiness Core project, and is not to be
confused with overall AllForOneBusiness Network Protocol consensus changes.

Whether a pull request is merged into AllForOneBusiness Core rests with the project merge
...
Patches that change AllForOneBusiness consensus rules are considerably more involved than
...
Where a patchset proposes to change the AllForOneBusiness consensus, it must have been
...
The project leader is the release manager for each AllForOneBusiness Core release.
