...
- 1) start one allforonebusinessd node from an pre-HD wallet wallet.dat file localized in util/data
...
class WalletUpgradeTest (AllForOneBusinessTestFramework):
