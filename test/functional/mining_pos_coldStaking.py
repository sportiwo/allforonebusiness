...
from test_framework.allforonebusiness_node import AllForOneBusinessTestNode
...
class AllForOneBusiness_ColdStakingTest(AllForOneBusinessTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(AllForOneBusinessTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 AFO from the pot)
...
if __name__ == '__main__':
    AllForOneBusiness_ColdStakingTest().main()
