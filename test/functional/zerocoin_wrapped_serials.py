...
from fake_stake.base_test import AllForOneBusiness_FakeStakeTest

class zAFOwrappedSerialsTest(AllForOneBusiness_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zAFOs..." % DENOM_TO_USE)
