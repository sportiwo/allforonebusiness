...
class MasternodeGovernanceBasicTest(AllForOneBusinessTestFramework):
    ...
    def setupMasternode(self,
        ...
        destPath = os.path.join(destinationDirPath, "allforonebusiness.conf")
        with open(destPath, "a+") as file_object:
            file_object.write("\n")
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.allforonebusiness.org/t/test-proposal"
