...
"""Verify that starting allforonebusiness with -h works as expected."""
import subprocess

from test_framework.test_framework import AllForOneBusinessTestFramework
from test_framework.util import assert_equal

class HelpTest(AllForOneBusinessTestFramework):
    ...
    def run_test(self):
        self.log.info("Start allforonebusiness with -? for help text")
        ...
        self.log.info("Start allforonebusiness with -version for version information")
