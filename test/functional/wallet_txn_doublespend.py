...
class TxnMallTest(AllForOneBusinessTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 6,250 AFO:
        ...
        # First: use raw transaction API to send 1240 * 5 AFO to node1_address,
        # but don't broadcast:
