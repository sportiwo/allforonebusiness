...
The build script we'll be using is contained in the AllForOneBusiness github repository ([contrib/gitian-build.py](https://github.com/allforonebusiness-project/allforonebusiness/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the AllForOneBusiness repository and will need to fetch this script with the following commands:
...
- Clone the gitian-builder, gitian.sigs, allforonebusiness-detached-sigs, and allforonebusiness GitHub repos.
