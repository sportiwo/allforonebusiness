...
The script [extract-osx-sdk.sh](https://github.com/allforonebusiness-project/allforonebusiness/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
allforonebusiness/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/allforonebusiness-project/allforonebusiness/blob/master/doc/README_osx.md) for troubleshooting tips.
