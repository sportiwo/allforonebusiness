...
def main():
    ...
    # Filter out hosts with multiple allforonebusiness ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple allforonebusiness ports' % (ip_stats(ips)), file=sys.stderr)
