...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the allforonebusiness repository."
  exit 1
fi
...
echo
echo 'When compiling allforonebusinessd, run `./configure` in the following way:'
echo
