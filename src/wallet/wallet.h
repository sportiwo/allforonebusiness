...
enum WalletFeature {
    ...
    FEATURE_PRE_AllForOneBusiness = 61000, // inherited version..
...
enum ZerocoinSpendStatus {
    ...
    ZAFO_TXMINT_GENERAL = 9,                        // General errors in MintsToInputVectorPublicSpend
...
public:
    ...
    void doZAfoRescan(const CBlockIndex* pindex, const CBlock& block, std::set<uint256>& setAddedToWallet, const Consensus::Params& consensus, bool fCheckZAFO);
    ...
    // zPIV wallet
    std::unique_ptr<CzAFOTracker> zafoTracker{nullptr};
    void setZWallet(CzAFOWallet* zwallet);
    CzAFOWallet* getZWallet();
