...
const struct NUInfo NetworkUpgradeInfo[Consensus::MAX_NETWORK_UPGRADES] = {
        {
                /*.strName =*/ "Base",
                /*.strInfo =*/ "AllForOneBusiness network",
        },
        {
                /*.strName =*/ "PoS",
        ...
        {
                /*.strName =*/ "AllForOneBusiness_v3.4",
                /*.strInfo =*/ "new 256-bit stake modifier - start block v6",
        },
        {
                /*.strName =*/ "AllForOneBusiness_v4.0",
                /*.strInfo =*/ "new message sigs - start block v7 - time protocol - zc spend v4",
        },
        {
                /*.strName =*/ "v5_dummy",
                /*.strInfo =*/ "Placeholder for future AllForOneBusiness version 5.0 upgrade",
        },
        {
                /*.strName =*/ "Test_dummy",
