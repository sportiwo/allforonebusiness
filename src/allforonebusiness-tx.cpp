...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("AllForOneBusiness Core allforonebusiness-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  allforonebusiness-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded allforonebusiness transaction") + "\n" +
                               "  allforonebusiness-tx [options] -create [commands]   " + _("Create hex-encoded allforonebusiness transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded allforonebusiness transaction
