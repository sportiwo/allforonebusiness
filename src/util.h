...
extern const char * const AllForOneBusiness_CONF_FILENAME;
extern const char * const AllForOneBusiness_PID_FILENAME;
extern const char * const AllForOneBusiness_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("allforonebusiness-%s", name);
