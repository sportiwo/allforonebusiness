...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop AllForOneBusiness server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "AllForOneBusiness server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AllForOneBusiness features */
        {"allforonebusiness", "listmasternodes", &listmasternodes, true, true, false},
        {"allforonebusiness", "getmasternodecount", &getmasternodecount, true, true, false},
        {"allforonebusiness", "masternodeconnect", &masternodeconnect, true, true, false},
        {"allforonebusiness", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"allforonebusiness", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"allforonebusiness", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"allforonebusiness", "masternodecurrent", &masternodecurrent, true, true, false},
        {"allforonebusiness", "masternodedebug", &masternodedebug, true, true, false},
        {"allforonebusiness", "startmasternode", &startmasternode, true, true, false},
        {"allforonebusiness", "createmasternodekey", &createmasternodekey, true, true, false},
        {"allforonebusiness", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"allforonebusiness", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"allforonebusiness", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"allforonebusiness", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"allforonebusiness", "getmasternodescores", &getmasternodescores, true, true, false},
        {"allforonebusiness", "preparebudget", &preparebudget, true, true, false},
        {"allforonebusiness", "submitbudget", &submitbudget, true, true, false},
        {"allforonebusiness", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"allforonebusiness", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"allforonebusiness", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"allforonebusiness", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"allforonebusiness", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"allforonebusiness", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"allforonebusiness", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"allforonebusiness", "checkbudgets", &checkbudgets, true, true, false},
        {"allforonebusiness", "mnsync", &mnsync, true, true, false},
        {"allforonebusiness", "spork", &spork, true, true, false},
        {"allforonebusiness", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzafoseed", &getzafoseed, false, false, true},
        {"zerocoin", "setzafoseed", &setzafoseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzafo", &searchdzafo, false, false, true},
        {"zerocoin", "dzafostate", &dzafostate, false, false, true},
...
{
    return "> allforonebusiness-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:11887/\n";
}
