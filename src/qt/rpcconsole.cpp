                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzAFOPathCustom = GetArg("-zafobackuppath", "");
    ...
    if(!strzAFOPathCustom.empty()) {
        ui->wallet_customzafobackuppath->setText(QString::fromStdString(strzAFOPathCustom));
        ui->wallet_customzafobackuppath_label->setVisible(true);
        ui->wallet_customzafobackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzAFOPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the AllForOneBusiness RPC console.") + "<br>" +
