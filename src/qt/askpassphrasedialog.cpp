...
#include "qt/allforonebusiness/loadingdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            AllForOneBusinessGUI* window = static_cast<AllForOneBusinessGUI*>(parentWidget());
...
{
    AllForOneBusinessGUI* gui = static_cast<AllForOneBusinessGUI*>(parentWidget());
...
{
    hide();
    static_cast<AllForOneBusinessGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
