...
/** Utility functions used by the AllForOneBusiness Qt UI.
 */
namespace GUIUtil
{
...
// Render AllForOneBusiness addresses in monospace font
...
// Parse "allforonebusiness:" URI into recipient object, return true on successful parsing
