...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, AllForOneBusinessGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, AllForOneBusinessGUI* gui, double posX = 3);
