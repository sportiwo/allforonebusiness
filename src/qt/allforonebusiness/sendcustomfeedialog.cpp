...
#include "qt/allforonebusiness/sendcustomfeedialog.h"
#include "qt/allforonebusiness/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(AllForOneBusinessGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &AllForOneBusinessGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
