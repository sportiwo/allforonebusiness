...
#include "qt/allforonebusiness/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/allforonebusiness/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(AllForOneBusinessGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    if (parent)
        connect(parent, &AllForOneBusinessGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
