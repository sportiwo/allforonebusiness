...
#include "qt/allforonebusiness/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(AllForOneBusinessGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("AllForOneBusiness_tx_csv_export(*.csv)") : tr("AllForOneBusiness_addresses_csv_export(*.csv)"),
                                        nullptr);
