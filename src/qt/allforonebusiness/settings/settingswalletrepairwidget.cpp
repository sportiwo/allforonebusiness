...
#include "qt/allforonebusiness/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/allforonebusiness/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(AllForOneBusinessGUI* _window, QWidget *parent) :
