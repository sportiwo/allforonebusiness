...
#include "qt/allforonebusiness/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/allforonebusiness/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(AllForOneBusinessGUI* _window, QWidget *parent) :
