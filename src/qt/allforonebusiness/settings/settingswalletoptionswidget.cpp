...
#include "qt/allforonebusiness/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/allforonebusiness/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(AllForOneBusinessGUI* _window, QWidget *parent) :
