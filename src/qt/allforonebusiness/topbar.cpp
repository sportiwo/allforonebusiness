...
#include "qt/allforonebusiness/forms/ui_topbar.h"
#include "qt/allforonebusiness/lockunlock.h"
#include "qt/allforonebusiness/qtutils.h"
#include "qt/allforonebusiness/receivedialog.h"
...
TopBar::TopBar(AllForOneBusinessGUI* _mainWindow, QWidget *parent) :
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // PIV
    // Top
    ui->labelAmountTopAfo->setText(totalAfo);
    // Expanded
    ui->labelAmountAfo->setText(totalAfo);
    ui->labelPendingAfo->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance, nDisplayUnit));
