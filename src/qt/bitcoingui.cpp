                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("AllForOneBusiness Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AllForOneBusiness address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and allforonebusiness: URIs)"));
...
//     privacyAction->setStatusTip(tr("Privacy Actions for zAFO"));
...
//     tabGroup->addAction(privacyAction);
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About AllForOneBusiness Core"), this);
    aboutAction->setStatusTip(tr("Show information about AllForOneBusiness Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for AllForOneBusiness"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AllForOneBusiness addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AllForOneBusiness addresses"));
    ...
    openAction->setStatusTip(tr("Open a AllForOneBusiness: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AllForOneBusiness Core help message to get a list with possible AllForOneBusiness command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AllForOneBusiness network", "", count));
}
...
void BitcoinGUI::message(const QString& title, const QString& message, unsigned int style, bool* ret)
{
    ...
    // Append title to "AllForOneBusiness - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
