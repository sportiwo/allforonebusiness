...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a AllForOneBusiness address (e.g. %1)").arg("D7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
...
{
    // return if URI is not valid or is no AllForOneBusiness: URI
...
void openConfigfile()
{
    ...
    /* Open allforonebusiness.conf with the associated application */
...
{
    // check for AllForOneBusiness.lnk
