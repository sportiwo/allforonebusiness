...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || gArgs.GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("AllForOneBusiness Core"),
     ...
     * override -datadir in the allforonebusiness.conf file in the default data directory
     * (to be consistent with allforonebusinessd behavior)
     */
