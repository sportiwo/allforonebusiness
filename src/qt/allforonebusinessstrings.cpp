...
#define UNUSED
#endif
static const char UNUSED *allforonebusiness_strings[] = {
QT_TRANSLATE_NOOP("allforonebusiness-core", " mints deleted\n"),
QT_TRANSLATE_NOOP("allforonebusiness-core", " mints updated, "),
QT_TRANSLATE_NOOP("allforonebusiness-core", " unconfirmed transactions removed\n"),
...
QT_TRANSLATE_NOOP("allforonebusiness-core", ""
"Disable all AllForOneBusiness specific functionality (Masternodes, Zerocoin, SwiftX, "
...
"your clock is wrong AllForOneBusiness Core will not work properly."),
QT_TRANSLATE_NOOP("allforonebusiness-core", ""
...
QT_TRANSLATE_NOOP("allforonebusiness-core", "Disable safemode, override a real safe mode event (default: %u)"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Discover own IP address (default: 1 when listening and no -externalip)"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Display the stake modifier calculations in the debug.log file."),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Display verbose coin stake messages in the debug.log file."),
...
QT_TRANSLATE_NOOP("allforonebusiness-core", "Enable publish raw block in <address>"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Enable publish raw transaction (locked via SwiftX) in <address>"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Enable publish raw transaction in <address>"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Enable staking functionality (0-1, default: %u)"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Enable the client to act as a masternode (0-1, default: %u)"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Error initializing block database"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Error initializing wallet database environment %s!"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Error loading block database"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Error loading wallet.dat"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Error loading wallet.dat: Wallet corrupted"),
...
QT_TRANSLATE_NOOP("allforonebusiness-core", "If <category> is not supplied, output all debugging information."),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Importing..."),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Imports blocks from external blk000??.dat file"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Include IP addresses in debug output (default: %u)"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Incorrect or no genesis block found. Wrong datadir for network?"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Information"),
...
QT_TRANSLATE_NOOP("allforonebusiness-core", "Pubcoin not found in mint tx"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "RPC server options:"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Randomly drop 1 of every <n> network messages"),
...
QT_TRANSLATE_NOOP("allforonebusiness-core", "Relay non-P2SH multisig (default: %u)"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Rescan the block chain for missing wallet transactions"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Rescanning..."),
QT_TRANSLATE_NOOP("allforonebusiness-core", "ResetMintZerocoin finished: "),
QT_TRANSLATE_NOOP("allforonebusiness-core", "ResetSpentZerocoin finished: "),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Run a thread to flush wallet periodically (default: %u)"),
...
QT_TRANSLATE_NOOP("allforonebusiness-core", "Set maximum block size in bytes (default: %d)"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Set minimum block size in bytes (default: %u)"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Set the Maximum reorg depth (default: %u)"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Set the masternode private key"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Set the number of threads to service RPC calls (default: %d)"),
...
QT_TRANSLATE_NOOP("allforonebusiness-core", "Specify data directory"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Specify masternode configuration file (default: %s)"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Specify pid file (default: %s)"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Specify wallet file (within data directory)"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Specify your own public address"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Spend Valid"),
...
QT_TRANSLATE_NOOP("allforonebusiness-core", "Tor control port to use if onion listening enabled (default: %s)"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Transaction Created"),
...
QT_TRANSLATE_NOOP("allforonebusiness-core", "Use a custom max chain reorganization depth (default: %u)"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Use block spam filter (default: %u)"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Use the test network"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "User Agent comment (%s) contains unsafe characters."),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Username for JSON-RPC connections"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Value is below the smallest available denomination (= 1) of zAFO"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Verifying blocks..."),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Verifying wallet..."),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Wallet %s resides outside data directory %s"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Wallet needed to be rewritten: restart AllForOneBusiness Core to complete"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Wallet options:"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Wallet window title"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Warning"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Warning: This version is obsolete, upgrade required!"),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Warning: Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("allforonebusiness-core", "Warning: Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("allforonebusiness-core", "You don't have enough Zerocoins in your wallet"),
