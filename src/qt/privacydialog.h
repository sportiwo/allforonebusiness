...
public:
    ...
    void setZafoControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzAFO_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzAFO_clicked();
    void on_pushButtonZafoControl_clicked();
