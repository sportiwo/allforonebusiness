...
// Wallet
    ...
    if (settings.contains("nAnonymizeAllForOneBusinessAmount"))
        SoftSetArg("-anonymizeallforonebusinessamount", settings.value("nAnonymizeAllForOneBusinessAmount").toString().toStdString());
