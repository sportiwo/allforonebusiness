 ...
 * AllForOneBusiness system. There are three: the main network on which people trade goods
...
public:
    ...
    int AllForOneBusinessBadBlockTime() const { return nAllForOneBusinessBadBlockTime; }
    int AllForOneBusinessBadBlocknBits() const { return nAllForOneBusinessBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nAllForOneBusinessBadBlockTime;
    unsigned int nAllForOneBusinessBadBlocknBits;
