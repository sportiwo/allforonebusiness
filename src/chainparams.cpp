...
public:
    CMainParams()
    {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000019f41f071f415bebcab0c232f5a87b54d549dcfd5f9304c08ca7d76dcb7"));
        assert(genesis.hashMerkleRoot == uint256S("0x787ff49cfa2ab696f7b6539006b01109b4920faffcfbc2b8bd493add6ea030bd"));
        ...
        // validation by-pass
        consensus.nAllForOneBusinessBadBlockTime = 1471401614;    // Skip nBit validation of Block 259201 per PR #915
        consensus.nAllForOneBusinessBadBlockBits = 0x1c056dac;    // Skip nBit validation of Block 259201 per PR #915
        ...
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].nActivationHeight         = 480000;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_PUBLIC].nActivationHeight     = 999999999;
        consensus.vUpgrades[Consensus::UPGRADE_V3_4].nActivationHeight          = 480000;
        consensus.vUpgrades[Consensus::UPGRADE_V4_0].nActivationHeight          = 481000;
        ...
        vSeeds.emplace_back("167.172.241.15", "167.172.241.15", true);
        vSeeds.emplace_back("167.71.100.75", "167.71.100.75", true);
        vSeeds.emplace_back("138.197.195.33", "138.197.195.33", true);
        vSeeds.emplace_back("138.197.108.214", "138.197.108.214", true);
        vSeeds.emplace_back("167.99.229.74", "167.99.229.74", true);
...
public:
    CTestNetParams()
    {
        ...
        // validation by-pass
        consensus.nAllForOneBusinessBadBlockTime = 1489001494; // Skip nBit validation of Block 201 per PR #915
        consensus.nAllForOneBusinessBadBlockBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        ...
        vSeeds.emplace_back("fuzzbawls.pw", "allforonebusiness-testnet.seed.fuzzbawls.pw", true);
        vSeeds.emplace_back("fuzzbawls.pw", "allforonebusiness-testnet.seed2.fuzzbawls.pw", true);

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet allforonebusiness addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet allforonebusiness script addresses start with '8' or '9'
