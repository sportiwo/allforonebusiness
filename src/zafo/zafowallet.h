...
#ifndef AllForOneBusiness_ZAFOWALLET_H
#define AllForOneBusiness_ZAFOWALLET_H
...
public:
    CzAFOWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZAFO(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZAFO(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //AllForOneBusiness_ZAFOWALLET_H
