...
#ifndef AllForOneBusiness_ZAFOTRACKER_H
#define AllForOneBusiness_ZAFOTRACKER_H
...
public:
    CzAFOTracker(std::string strWalletFile);
    ~CzAFOTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzAFOWallet* zAFOWallet = NULL);
...
#endif //AllForOneBusiness_ZAFOTRACKER_H
