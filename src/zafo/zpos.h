...
#ifndef AllForOneBusiness_LEGACY_ZPOS_H
#define AllForOneBusiness_LEGACY_ZPOS_H

#include "stakeinput.h"
#include "txdb.h"

class CLegacyZAfoStake : public CStakeInput
{
private:
    uint32_t nChecksum;
...
public:
    CLegacyZAfoStake() : CStakeInput(nullptr) {}

    explicit CLegacyZAfoStake(const libzerocoin::CoinSpend& spend);
    bool InitFromTxIn(const CTxIn& txin) override;
    bool IsZAFO() const override { return true; }
